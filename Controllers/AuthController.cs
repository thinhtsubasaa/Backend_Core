...
namespace ERP.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IConfiguration _configuration, RoleManager<ApplicationRole> _roleManager, IUnitofWork _uow, UserManager<ApplicationUser> _userManager, SignInManager<ApplicationUser> _signInManager, IOptions<AppSettings> _appSettings, IConfiguration _config)
        {
            uow = _uow;
...
new Claim(ClaimTypes.Name, userToken.Id)
            ...
            return new InfoLogin() { Token = tokenHandler.WriteToken(token), Id = userToken.Id, Email = userToken.Email, FullName = userToken.FullName, Expires = token.ValidTo, MustChangePass = userToken.MustChangePass, AccessRole = accessRole, HinhAnhUrl = userhinhanh.HinhAnhUrl };
        }
